...
import { injectedForApprove, injectedForTx } from './ethereum'
    ...
    cy.intercept(
      ...
      original({
        ...
        onBeforeLoad(win) {
          ...
          win.ethereum = injectedForTx
          if (url.endsWith('type=newWallet')) {
            win.ethereum = injectedForApprove
          }
        },
      })
    })
