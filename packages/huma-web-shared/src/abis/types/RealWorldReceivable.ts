...
export interface RealWorldReceivableInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'createRealWorldReceivable',
    values: [
  ...
  encodeFunctionData(
    functionFragment: 'rwrInfoMapping',
    values: [PromiseOrValue<BigNumberish>],
  ): string
  encodeFunctionData(
...
export interface RealWorldReceivable extends BaseContract {
  ...
  filters: {
    ...
    'PaymentDeclared(address,address,uint256,uint16,uint256)'(
    ...
    'ReceivableCreated(address,uint256,address,uint256,uint64,uint16)'(
      owner?: PromiseOrValue<string> | null,
      tokenId?: PromiseOrValue<BigNumberish> | null,
