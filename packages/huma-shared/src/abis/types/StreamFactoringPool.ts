...
export declare namespace StreamFactoringPoolStorage {
...
export interface StreamFactoringPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'drawdownWithAuthorization',
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
...
export interface StreamFactoringPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: StreamFactoringPoolInterface
  ...
  functions: {
    ...
    getCoreData(overrides?: CallOverrides): Promise<
    ...
    streamInfoMapping(
      ...
      receivableTokenId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides,
    ): Promise<[StreamFactoringPoolStorage.StreamInfoStructOutput]>
