...
export interface TrancheVaultNoAutoredemptionUpgradeInterface
...
export interface TrancheVaultNoAutoredemptionUpgrade extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: TrancheVaultNoAutoredemptionUpgradeInterface
