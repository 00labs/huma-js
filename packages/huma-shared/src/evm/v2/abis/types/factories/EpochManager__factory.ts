...
import type { EpochManager, EpochManagerInterface } from '../EpochManager'
...
const _abi = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct EpochManager.CurrentEpoch',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract ITrancheVaultLike',
        name: '',
        type: 'address',
      },
    ],
  ...
  {
    inputs: [],
    name: 'minAmountToProcessPerEpoch',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
...
export class EpochManager__factory {
